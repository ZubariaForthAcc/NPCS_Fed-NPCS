...
import npcs.Rewrite.RewriteService;
...
public class App {
	...
	System.out.println("write query/path in second argument to tell you are sending query or path");	
		...
		if(reification_scheme.equals("Service_SPARQL_Star"))
		{
			RewriteService rws=new RewriteService();
			long startTime = System.currentTimeMillis();

			// Perform the operation
			System.out.println(rws.runJar(reification_scheme, "query", query));
